...
public class Application1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("compareTo() : " + (str2.compareTo(str4))); //32 크면 양수를 반환
        ...
        * */
        ...
        System.out.println("lastIndexOf('a') : " + indexOf.lastIndexOf('a')); //7 (문자열은 공백 포함)
        ...
        * */
        ...
        System.out.println("substring(3, 6) " + javaoracle.substring(3, 7)); //6전까지
        System.out.println("substring(3) " + javaoracle.substring(3));

        System.out.println("javaoracle : " + javaoracle); //원본 영향 x
        ...
        String str6 = null; //있는것도 아니고 없는것도 아님
        String str7 = ""; //0
