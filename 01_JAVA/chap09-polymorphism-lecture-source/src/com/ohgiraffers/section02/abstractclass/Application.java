...
public class Application {
    public static void main(String[] args) {
        ...
        /*
        * 추상클래스와 추상메소드
        * 추상메소드를 0개 이상 포함하는 클래스를 추상클래스라고한다.
        * 추상클래스는 클래스 선언부 abstract 키워드를 명시해야한다.
        * 추상클래스로는 인스턴스 생성이 불가능하다.
        * 추상클래스를 사용하려면 추상클래스를 상속 받는 하위클래스를 이용하여 인스턴스를 생성해야한다.
        ...
        * 자바에서는 extends 클래스를 상속받을 시 하나의 부모 클래스만 가질 수 있다.
        * */
        ...
        * 예) public abstract void method(); <-- {} 괄호가 없다.
        * */

        //Product product = new Product(); //추상클래스는 인스턴스 생성불가
        ...
        * 그래서 추상클래스보다 더 강제성이 강한 인터페이스(interface)라는 메커니즘을 제공하고있다.
        * */
