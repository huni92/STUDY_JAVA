...
public class D_switch {
    public void testSimpleSwitchStatement() {
        ...
        char op = sc.next().charAt(0); //nextLine 에러 Exception in thread "main" java.lang.StringIndexOutOfBoundsException: String index out of range: 0
